...
void main(triangle SferGeometryInput i[3], inout TriangleStream<SferGeometryInput> Output)
{
    ...
    float noise = (SimplexNoise(float2(((i[0].WorldPosition.x * 2) + FB_TotalTime * 0.1), ((i[0].WorldPosition.z * 2) + FB_TotalTime * 0.1))) - 0.5);
    ...
    */
    ...
    V1.Position = V1.Position + float4((noise*0.1), 1.5, 0, 0);
    V1.WorldPosition = V1.WorldPosition + float4((noise*0.01), 1.5, 0, 0);
