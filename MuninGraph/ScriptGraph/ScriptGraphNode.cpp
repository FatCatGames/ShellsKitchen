...
void ScriptGraphNode::SetDescription(const std::string& aDescription)
{
	myDescription = aDescription;
}

void ScriptGraphNode::SetCategory(const std::string& aCategory)
{
	myCategory = aCategory;
}

void ScriptGraphNode::SetAcessibility(const std::string& aAcess)
{
