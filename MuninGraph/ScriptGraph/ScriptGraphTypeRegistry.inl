...
void RenderConstructWidget(const std::string& aContainerUUID, void* aDataPtr, const ScriptGraphType& /*aTypeInfo*/) override
{
	...
	ImGui::DragFloat(aContainerUUID.c_str(), (float*)aDataPtr, 1, -FLT_MAX, FLT_MAX, "%.1f");
}
...
void RenderConstructWidget(const std::string& aContainerUUID, void* aDataPtr, const ScriptGraphType& /*aTypeInfo*/) override
{
	const float y = ImGui::GetCursorPosY(); ImGui::SetCursorPosY(y - 2); ImGui::Checkbox(aContainerUUID.c_str(), (bool*)aDataPtr);
}
